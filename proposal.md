...
An additional step of filtering will be performed to limit the number of stations to be explored, reducing the size of the working dataset. Lastly, the data will be aggregated as required to show monthly averages pollution levels.
